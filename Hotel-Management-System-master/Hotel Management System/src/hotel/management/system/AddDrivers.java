...
public class AddDrivers extends JFrame implements ActionListener {
    ...
    public AddDrivers() {
        ...
        // Setting up the image on the right side of the panel
        ...
        b1.setName("b1");  // Set a name for the button
        contentPane.add(b1);
        ...
        b2.setName("b2");  // Set a name for the button (optional, for testing purposes)
        contentPane.add(b2);
